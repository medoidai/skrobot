...
In the table below you can see the components that can extend the module to support new tasks or notifiers:
...
* Add support in the module for multiclass and regression problems
