...
Also, the results of the experiment can be found in the [example-pipeline-with-model-based-feature-selection](https://github.com/medoidai/sand/tree/master/examples/output/echatzikyriakidis-2020-07-04T01-22-09-example-pipeline-with-model-based-feature-selection) directory.
