...
Sand is a Python module for designing, running and tracking Machine Learning experiments / tasks for binary classification problems. It is built on top of [scikit-learn](https://scikit-learn.org/) framework.
