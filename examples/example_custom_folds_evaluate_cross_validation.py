...
results = experiment.run(EvaluateCrossValidationMlTask(estimator_template=estimator,
                                                       ...
                                                       random_seed=random_seed).custom_folds(folds_file_path=path.join('data','folds.csv')))
